...
# Ex. Data Clean, Data Visualization, Results Export
...
*First, pull data into the `raw_data` file we created while going through file structure. Next, create a script called `0_data_clean.R` in the `scripts` folder*
...
# -------------------------------------------------------------------------
myData %>% # Pipe data 
  mutate(cyl = as.factor(cyl)) %>% # data manipulation (show this commented)
