...
3) Navigate to file you want the r project to exist in
...
- File structure can make or break a research project
  - Functions as an outline that gives you forward momentum 
...
Special thanks to Matt Wibbenmeyer (fellow at RFF) who wrote a Notes on Project Management and Collaboration for RFF RAs and interns that I still use. It is worth reading and you can find it [here](lecture_material/4_data_manage_vis/Wibbenmeyer_notes_proj_collab.pdf)


There will be your **project** `project/`. This is the file your R Project files lives. Everything else will be in this folder or sub folders. 

**subfolders**

- `data/`
    - `raw_data/`: The orginal data. Do not edit this! You never know when what you originally thought was a good idea was actually bad. Always keep a copy of your original data here. 
