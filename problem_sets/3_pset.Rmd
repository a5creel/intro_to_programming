...
Do this problem set in a Google Collab. Use comments or text sections (text cells vs code cells) to indicate which question you're on. 

Once you have completed your problem set, on Google Collab go to "File > Download > Download .ipynb" OR "File > Download > Download .ipynb" to download your file as a Jupyter Notebook OR a python script. You may turn in the Jupyter Notebook (your_pset.ipynb) or python script (your_pset.py) to canvas.
